...
def generate_clients():
    ...
    for i in range(1, 401):  # Generate 400 clients
...
def generate_complaints():
    ...
    for i in range(1, 301):  # Generate 300 complaints
...
def generate_membership_issues():
    ...
    current_date = datetime.now()
    for i in range(1, 201):  # Generate 200 membership issues
...
def generate_contract_breaches():
    ...
    current_date = datetime.now()
    for i in range(1, 151):  # Generate 150 contract breaches
